...
if resume:
    checkpoint = torch.load("experiments/MNIST/MLP/final/pretrain_PGDs/REx_waterfall_lr_init_0.01/model_AIT_REx_870.pt")
...
TRAINED_MODEL_PATH = "experiments/MNIST/MLP/final/pretrain_PGDs/"
if is_REx:
