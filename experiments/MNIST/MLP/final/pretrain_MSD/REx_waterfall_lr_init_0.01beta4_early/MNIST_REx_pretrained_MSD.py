...
if resume:
    checkpoint = torch.load("experiments/MNIST/MLP/final/pretrain_MSD/REx_waterfall_lr_init_0.01beta4/model_AIT_REx_620.pt")
...
TRAINED_MODEL_PATH = "experiments/MNIST/MLP/final/pretrain_MSD/"
if is_REx:
