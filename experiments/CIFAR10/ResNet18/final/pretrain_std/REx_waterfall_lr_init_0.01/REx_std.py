...
if resume:
    checkpoint = torch.load("experiments/CIFAR10/ResNet18/pretrain_std/ERM_lr_init_0.01/model_AIT_ERM_300.pt")
...
TRAINED_MODEL_PATH = "experiments/CIFAR10/ResNet18/pretrain_std/"
if is_REx:
